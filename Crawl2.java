//importing java packaged used in class file
...
public class Crawl2 {
	...
	private long crawl2Time;
	private int speed;

	//crawl2 constructor assigning variable values
	public Crawl2() {	
		...
		crawl2Time = System.currentTimeMillis();
		this.speed = 7;
	...
	public void draw() {
		...
		StdDraw.text(x, y, "The Rebel Fleet has arrived!");
		StdDraw.text(x, y2, "Endor is saved!");
		StdDraw.show(100);
		move();
	}
